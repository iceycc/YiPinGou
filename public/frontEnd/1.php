...
?>
  ...
  <footer class="site-info" itemscope itemtype="http://schema.org/WPFooter">
    ...
    <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'flat' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'flat' ); ?>">
      <?php printf( __( 'Proudly powered by %s', 'flat' ), '王冰洋' ); ?>
    </a>.
